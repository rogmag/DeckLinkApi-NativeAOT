...
namespace DeckLinkApi.Interop
{
	...
	[Guid("065A0F6C-C508-4D0D-B919-F5EB0EBFC96B")]
	[InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
	public partial interface IDeckLinkOutput_v11_4
	{
		void DoesSupportVideoMode(BMDVideoConnection connection, BMDDisplayMode requestedMode, BMDPixelFormat requestedPixelFormat, BMDSupportedVideoModeFlags flags, out BMDDisplayMode actualMode, [MarshalAs(UnmanagedType.Bool)] out bool supported);
